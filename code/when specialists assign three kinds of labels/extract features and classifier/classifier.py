...
# NB
mnb = OneVsRestClassifier(GaussianNB())
...
# RF 
rf = OneVsRestClassifier(RandomForestClassifier(max_depth=13, n_estimators=60, criterion ="entropy",min_samples_split=300,min_samples_leaf=30))
rf.fit(X_train, y_train)
y_predict = rf.predict(X_test)
print('The Accuracy of RF Classifier is:', rf.score(X_test,y_test))
