...
print("init model ")
model = OneVsRestClassifier(RandomForestClassifier(n_estimators= 60, max_depth= 13, min_samples_split= 110, min_samples_leaf= 20))
...
for round in range(1):
    ...
    test_auc = metrics.roc_auc_score(y[test_idx], y_predict_prob)
    ...
    while len(unlab_ind.index) > 0:
        ...
        select_ind1, select_ind2 = uncertainStrategy.select(label_ind, unlab_ind, model=model, batch_size=2)
